...
def recv_message(client, userdata, message):
    ...
    try:
        ...
        if jsonobj['method'] == "setLed" and jsonobj['params'] == True:
            cmd = 1
        if jsonobj['method'] == "setLed" and jsonobj['params'] == False:
            cmd = 2
        if jsonobj['method'] == "setFan" and jsonobj['params'] == True:
            cmd = 3
        if jsonobj['method'] == "setFan" and jsonobj['params'] == False:
            cmd = 4
